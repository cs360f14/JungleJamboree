...
class Inventory :
	...
	def checkItemAmount (self, item, inventory, amount) :
		""" checks the amount of the item passed in. returns true
			if it is appropriate amount. otherwise, return false. """
	...
	def checkFoodAmount (self, inventory, amount) :
		""" checks the amount of food. returns true if it is an
			appropriate amount. otherwise, return false. """
	...
	def checkMouse (self, mouse, left, right, top, bottom):
		""" Checks if the mouse pointer is located in the 
			box passed in """
		isIn = False
